...
@section('admin')
    ...
    <form action="{{route('action.addStaff.db')}}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="example-designation" class="form-control" name="designation" placeholder="designation">
        </div>
        @error('designation')
        <span class="text-danger">{{$message}}</span>
        @enderror
